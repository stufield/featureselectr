...
fs_setup <- feature_selection(data, candidate_markers = feats,
...
```{r plot-nb, warning = FALSE, out.width = "100%", fig.width = 10, fig.height = 5}
plot(fs_nb)
```
...
fs_update <- update(
  fs_setup,
  model_type = model_type_lr(response = "class_response"),
  stratified = TRUE
)

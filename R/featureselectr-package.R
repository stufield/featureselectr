...
## usethis namespace: start
#' @useDynLib featureselectr, .registration = TRUE
## usethis namespace: end
NULL
...
.onLoad <- function(...) {
  ...
  register_s3_method("featureselectr", ".fitmodel", "fs_lr")
  register_s3_method("featureselectr", ".fitmodel", "fs_lm")
  register_s3_method("featureselectr", ".fitmodel", "fs_nb")
